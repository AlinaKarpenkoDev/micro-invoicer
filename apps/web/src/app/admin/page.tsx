                ...
                >
                  ...
                  <td className="whitespace-nowrap px-6 py-4 text-right text-sm">
                    <button
                      ...
                      className="inline-flex items-center justify-center rounded-md bg-black px-3 py-1.5 text-xs font-bold text-white transition-all hover:bg-gray-800 focus:outline-none"
                    >
                      Увійти як
                    </button>
                  </td>
